    ...
    def create_buttons(self):
        ...
        for button in self.buttons:
            if button == '=':
                ...
                btn = tk.Button(self.root, text=button, padx=15, pady=25, command=self.calculator.open_new_window)
            elif button == 'Bin':
                btn = tk.Button(self.root, text=button, padx=25, pady=25, command=self.calculator.convert_to_binary)
            elif button == 'Hex':
                btn = tk.Button(self.root, text=button, padx=25, pady=25, command=self.calculator.convert_to_hexadecimal)
            elif button == 'Clear':
...
class Calculator:
    def __init__(self, root):
        ...
        #clear_button = tk.Button(root, text="Clear", padx=30, pady=25, command=self.clear)
